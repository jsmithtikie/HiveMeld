 ...
 * This file demonstrates how to integrate Hivemeld with a web frontend
 */

// For React/Vue/Angular applications
export class HivemeldClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new HivemeldClient(provider, contractAddress);
